...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/bootstrap-switch/dist/css/bootstrap3/bootstrap-switch.min.css">
    <link rel="stylesheet" type="text/css" href="/assets/checkbox3/dist/checkbox3.min.css">
...
<body class="flat-blue landing-page">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">
                    ...
                    <div class="title">Security Portal</div>
                </a>
            </div>
            <div id="navbar" class="navbar-collapse collapse " aria-expanded="true">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="page-scroll" href="/login"><i class="fa fa-lock"></i> Login</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
        </div>
    </nav>
    <div class="jumbotron app-header" id="home">
        <div class="container">
    ...
    <div class="container-fluid app-content-b feature-1" id="about">
        <div class="container">
            <div class="row">
    ...
    <div class="container-fluid app-content-b contact-us" id="contact">
        <div class="container">
    ...
    <script type="text/javascript" src="/assets/bootstrap-switch/dist/js/bootstrap-switch.min.js"></script>
    ...
    <script type="text/javascript" src="/assets/ace-builds/src/ace.js"></script>
    <script type="text/javascript" src="/assets/ace-builds/src/mode-html.js"></script>
    <script type="text/javascript" src="/assets/ace-builds/src/theme-github.js"></script>
    <script type="text/javascript" src="/js/jqueryeasy.js"></script>
